...
//    📌 จำไว้: 1 ออเดอร์ของเรา = 1 เอกสารใน FlowAccount เท่านั้น (เห็นได้ที่ เอกสารขาย → ขายเงินสด เลขขึ้นต้น CA)
//       กติกา "1 ออเดอร์ = 2 เอกสาร" ที่ FlowAccount บอก ใช้กับคนที่ออกใบกำกับกับใบเสร็จแยกกัน — ไม่ใช่เรา
//       (เคยคำนวณโควตาผิดเพราะเอากติกานั้นมาใช้ คิมทักเอง 13 ส.ค. 69 พร้อมภาพหน้าจอ)
