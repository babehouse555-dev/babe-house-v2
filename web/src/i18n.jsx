...
const DICT = {
  ...
  cmp_peek_demo: { th: "ตัวอย่าง", en: "SAMPLE" },
  cmp_peek_grew: { th: "ผู้ติดตามโตขึ้นจากเดือนแรก", en: "Follower growth from month 1" },
  cmp_peek_b1: { th: "กราฟผู้ติดตามเทียบกันทุกเดือน เห็นชัดว่าเดือนไหนโตดี", en: "Month-by-month follower chart — see exactly which month grew best" },
  cmp_peek_b2: { th: "ครูพี่คิมอ่านตัวเลขให้ว่าอะไรได้ผล ควรทำอะไรต่อ", en: "Kim reads your numbers and tells you what worked and what's next" },
  cmp_peek_b3: { th: "ดาวน์โหลดรายงานการเติบโตเป็นไฟล์ Excel ส่งต่อลูกค้า/แบรนด์ได้", en: "Download a growth report as Excel to share with clients or brands" },
  cmp_peek_note: { th: "ยิ่งอยู่กับเราหลายเดือน กราฟยิ่งยาว ยิ่งเห็นภาพการเติบโตของตัวเองชัดขึ้นค่ะ", en: "The longer you stay, the longer your chart — and the clearer your growth story" },
  ...
  pd_submit: { th: "📮 ส่งบรีฟให้ทีมโปรดักชั่น →", en: "📮 Send brief to the production team →" },
  ...
  pd_sending: { th: "กำลังส่ง…", en: "Sending…" },
  pd_sent_ok: { th: "ส่งบรีฟให้ทีมเรียบร้อยแล้วค่ะ 🩵 เลขที่คำขอ", en: "Your brief has been sent to the team 🩵 Reference" },
  pd_sent_next: { th: "ทีมจะติดต่อกลับภายในวันทำการถัดไป (จันทร์-ศุกร์ 12:00-19:00 น.)", en: "The team will get back to you within the next working day (Mon-Fri 12:00-19:00)" },
  pd_selfserve: { th: "💡 ถ้าเป็นคลิปสั้น สั่งและจ่ายเองได้เลยไม่ต้องรอทีมตอบ", en: "💡 For short clips you can order and pay right away — no waiting" },
  pd_selfserve_link: { th: "สั่งตัดคลิปสั้นเลย →", en: "Order clip editing →" },
  ...
  // 🎯 2 คำถามกัน "แผนไม่ตรงแนวที่อยากทำ" (เพิ่ม 2 ส.ค. หลังเจอลูกค้า 3 รายในวันเดียว)
  fm_want_q: { th: "เดือนนี้อยากได้คอนเทนต์แนวไหน?", en: "What kind of content do you want this month?" },
  fm_want_tag: { th: "(สำคัญมาก — ครูพี่คิมจะวางแผนตามนี้)", en: "(important — Kim plans around this)" },
  fm_want_ph: { th: "เช่น เม้าท์มอยเหมือนเพื่อนคุยกัน · vlog ชีวิตประจำวัน · GRWM แต่งตัวไปเรียน · พาไปคาเฟ่ · แชร์ของที่ใช้จริง", en: "e.g. chatty like a friend · daily vlog · GRWM · cafe trips · sharing what I actually use" },
  fm_want_hint: { th: "บอกทั้งฟอร์แมตที่ชอบ และโทนที่อยากให้คนดูรู้สึก — ยิ่งบอกละเอียด แผนยิ่งตรงตัวคุณ", en: "Tell us both the formats you like and how you want viewers to feel — the more detail, the better the fit" },
  fm_avoid_q: { th: "แนวไหนที่ไม่อยากได้?", en: "What kind of content do you NOT want?" },
  fm_avoid_tag: { th: "(บอกได้เลย ครูพี่คิมจะเลี่ยงให้)", en: "(just say it — Kim will avoid it)" },
  fm_avoid_ph: { th: "เช่น ไม่เอาสอนแบบความรู้จ๋า · ไม่เอารีวิวสกินแคร์ · ไม่เอาขายตรงแรงๆ · ไม่ถนัดพูดหน้ากล้องยาวๆ", en: "e.g. no lecture-style teaching · no skincare reviews · no hard selling · not comfortable on camera for long" },
  fm_avoid_hint: { th: "ข้อนี้ช่วยได้มาก — บอกสิ่งที่ไม่อยากได้ จะได้ไม่ต้องมาแก้ทีหลัง", en: "This helps a lot — telling us what to skip saves fixing it later" },
  ...
  fm_v_example: { th: "ยังมีข้อความตัวอย่างของ Babe House ค้างอยู่ในฟอร์มนะคะ 🙏 ช่วยแก้เป็นข้อมูลช่อง/ธุรกิจของคุณเองก่อนค่ะ ไม่งั้นครูพี่คิมจะวิเคราะห์ผิดช่องค่ะ", en: "The Babe House sample text is still in the form. Please replace it with your own channel/business details first." },
  ...
  db_cal_empty_sub: { th: "กดปุ่มด้านล่างสร้างแผนคอนเทนต์ 30 วันได้เลยค่ะ (อยากอ่านบทวิเคราะห์ก่อนก็กดลิงก์ด้านล่างได้นะคะ) 🩵", en: "Tap below to generate your 30-day content plan (or read the analysis first via the link below) 🩵" },
  db_go_confirm: { th: "← ไปยืนยันบทวิเคราะห์", en: "← Go confirm the analysis" },
  db_gen_plan_now: { th: "✨ สร้างแผน 30 วันเลย", en: "✨ Generate my 30-day plan" },
  db_read_analysis_first: { th: "หรืออ่านบทวิเคราะห์ก่อน", en: "or read the analysis first" },
  ...
  se_edit: { th: "แก้ไข", en: "Edit" },
  se_edit_hint: { th: "แก้คำพูดให้เป็นสไตล์ตัวเองได้เลย แล้วกดบันทึก (กดคืนค่าต้นฉบับ AI ได้ถ้าไม่ชอบ)", en: "Edit the wording into your own voice, then save (you can restore the AI original anytime)" },
  se_edited_tag: { th: "แก้ไขแล้ว", en: "Edited" },
  se_save: { th: "💾 บันทึก", en: "💾 Save" },
  se_saving: { th: "กำลังบันทึก…", en: "Saving…" },
  se_revert: { th: "↩️ คืนค่าต้นฉบับ AI", en: "↩️ Restore AI original" },
  se_cancel: { th: "ยกเลิก", en: "Cancel" },
  se_regen: { th: "เจนใหม่ (ฟรี)", en: "Regenerate (free)" },
  se_regening: { th: "กำลังเจนใหม่…", en: "Regenerating…" },
  se_regen_used: { th: "เจนใหม่แล้ว", en: "Regenerated" },
  se_regen_confirm: { th: "เจนสคริปต์นี้ใหม่? ใช้สิทธิ์ฟรีได้ 1 ครั้งต่อสคริปต์นะคะ (ของเดิมจะถูกแทนที่)", en: "Regenerate this script? You get 1 free regeneration per script (this will replace the current one)." },
  se_regen_title: { th: "เจนสคริปต์นี้ใหม่ (ฟรี 1 ครั้ง)", en: "Regenerate this script (free once)" },
  ...
  db_tab_overview: { th: "ภาพรวม", en: "Overview" },
  ov_title: { th: "ภาพรวมคอนเทนต์เดือนนี้", en: "This month's content" },
  ov_posted: { th: "ลงแล้ว", en: "Posted" },
  ov_sponsors: { th: "งานสปอนเซอร์", en: "Sponsor scripts" },
  ov_credits: { th: "เครดิตเหลือ", en: "Credits left" },
  ov_remaining: { th: "เหลืออีก {n} วัน", en: "{n} days left" },
  ov_plan30: { th: "แผน 30 วัน — กดวันเพื่อดูสคริปต์", en: "30-day plan — tap a day for its script" },
  ov_sponsor_section: { th: "งานสปอนเซอร์ / ด่วน", en: "Sponsor / quick scripts" },
  ov_none_sponsor: { th: "ยังไม่มีงานสปอนเซอร์เดือนนี้ — สร้างได้ที่เครื่องมือด้านล่าง", en: "No sponsor scripts yet — create one in the tools below" },
  ov_manage_sponsor: { th: "จัดการงานสปอนเซอร์", en: "Manage sponsor scripts" },
