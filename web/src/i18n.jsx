...
const DICT = {
  ...
  fm_platform_hint: { th: "เลือกช่องที่คนติดตามเราจริงนะคะ — เล่มนี้จะเจาะช่องนั้นช่องเดียวเต็มที่ เพราะ TikTok กับ Instagram เล่นคนละแบบกันเลย ถ้าวางแผนให้ครอบทั้งสองช่องพร้อมกัน คอนเทนต์จะออกมากลางๆ ไม่เวิร์กกับช่องไหนสักช่องค่ะ", en: "Pick where your followers actually are — this plan goes all-in on that one platform. TikTok and Instagram work very differently; planning for both at once produces content that works for neither." },
  ...
  // 🔁 แก้คำตอบแล้วเขียนแผนใหม่ทั้งเล่ม — ใช้ตอนที่มีแผน 30 วันแล้วแต่ยังไม่ตรงใจ (ฟรี 1 ครั้ง · คิมสั่ง 5 ส.ค.)
  db_redo_cta: { th: "✏️ แผนยังไม่ตรงใจ? แก้คำตอบแล้วเขียนใหม่ (ฟรี)", en: "✏️ Plan not quite right? Edit your answers and rewrite (free)" },
  db_redo_cta_sub: { th: "บอกแนวที่อยากได้/ไม่อยากได้ แล้วครูพี่คิมจะเขียนแผน 30 วันใหม่ให้ทั้งชุด", en: "Tell Kim what you do and don't want, and she'll rewrite all 30 days" },
  db_redo_used: { th: "✓ ใช้สิทธิ์เขียนใหม่ฟรีของเล่มนี้ไปแล้ว — ถ้ายังไม่ตรงใจ ทักแอดมินได้เลยนะคะ 🩵", en: "✓ You've used this book's free rewrite — if it's still not right, message our admin 🩵" },
  db_redo_warn_title: { th: "⚠️ กดแล้วแผน 30 วันชุดเดิมจะถูกเขียนใหม่ทั้งหมด", en: "⚠️ This rewrites your entire 30-day plan" },
  db_redo_warn_body: { th: "ปฏิทินและสคริปต์ชุดใหม่จะมาแทนของเดิม รวมถึงสคริปต์รายวันที่เคยแก้เองไว้ด้วยค่ะ ถ้ามีอันไหนที่ชอบอยู่แล้ว คัดลอกเก็บไว้ก่อนนะคะ", en: "A new calendar and scripts will replace the current ones, including any daily scripts you edited yourself. If there's something you like, copy it first." },
  db_redo_submit: { th: "เขียนแผน 30 วันใหม่ให้ฉัน", en: "Rewrite my 30-day plan" },
  db_redoing_title: { th: "ครูพี่คิมกำลังเขียนแผนใหม่ให้คุณ... 🩵", en: "Kim is rewriting your plan… 🩵" },
  db_redoing_sub: { th: "อ่านสิ่งที่คุณบอกใหม่ทั้งหมด แล้วเขียนบทวิเคราะห์ + สคริปต์ 30 วันใหม่ให้ทั้งชุด ใช้เวลาประมาณ 2-3 นาที ไม่ต้องปิดหน้านะคะ — หรือปิดไปก่อนก็ได้ เดี๋ยวมีเมลแจ้งตอนเสร็จค่ะ ✨", en: "Reading everything you told us, then rewriting your analysis and all 30 scripts — about 2–3 minutes. Keep this page open, or close it and we'll email you when it's ready ✨" },
