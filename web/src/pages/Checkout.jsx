    ...
    <div className="wrap page-pad">
      ...
      <div className="card" style={{ maxWidth: 460, margin: "0 auto" }}>
        ...
        {isMock ? <>
          ...
          {/* 💸 พร้อมเพย์บางครั้ง "ตัดเงินแล้วแต่ระบบยังไม่ขึ้น" — เจอจริง 13 ส.ค. 69
              ลูกค้าโอนสำเร็จ 17:03 (มีสลิปเข้า Stripe จริง) แต่ Stripe ยังไม่จับคู่ให้
              ลูกค้าเลยคิดว่าพลาด ไปกรอกฟอร์มใหม่ กลายเป็น 2 ใบ แล้วทักมาถาม
              ⛔ ห้ามเขียนว่า "QR หมดอายุใน 15 นาที" — ตอนแรกเข้าใจผิดแบบนั้น แต่สลิปพิสูจน์ว่าไม่จริง
              → บอกสิ่งที่ช่วยได้จริง: ถ้าตัดเงินแล้วไม่ขึ้น อย่ากรอกใหม่ ให้กดแจ้งทีม */}
          <div style={{ background: "#FFF8EC", border: "1px solid #f0d9ae", borderRadius: 12,
            ...
            💸 <b>จ่ายพร้อมเพย์แล้วรอสักครู่นะคะ</b> — บางครั้งธนาคารส่งข้อมูลช้าสัก 1-2 นาที
            <br />ถ้าเงินถูกตัดแล้วแต่หน้ายังไม่เปลี่ยน <b>อย่าเพิ่งกรอกฟอร์มใหม่</b> ให้กด
            <b> “จ่ายเงินไปแล้วแต่ยังไม่ได้รับเล่ม”</b> ด้านล่าง แล้วส่งสลิปมา เดี๋ยวทีมเปิดให้ทันทีค่ะ
          </div>
