          ...
          <div style={{ ...card, marginTop: 12, background: "linear-gradient(135deg,#F6F2FE,#FBF9FF)", border: "1px solid #e4d8f2" }}>
            ...
            <div style={{ display: "flex", gap: 22, flexWrap: "wrap" }}>
              ...
              <Cell n={`฿${(m.pay || 0).toLocaleString()}`}
                l={(m.inhouse || salaried) ? `ค่าขนมงานที่ทำเพิ่ม (คลิปละ ฿${(m.rate || 0).toLocaleString()})` : `ยอดเดือนนี้ (คลิปละ ฿${(m.rate || 0).toLocaleString()})`}
                tone="#1a7f43" />
            ...
            {m.inhouse ? (
              ...
              /* 🎨 fairy — งานประจำคือ "กราฟฟิก" ส่วนงานตัดต่อคือของที่รับเพิ่มเสมอ ไม่ว่าจะวันไหน
                 เลยคิดค่าขนมทุกคลิป แต่ต้องบอกให้ชัดว่างานกราฟฟิกอยู่ในเงินเดือนแล้ว ไม่ได้หายไปไหน */
              <div className="muted" style={{ fontSize: 12.5, marginTop: 9, lineHeight: 1.7 }}>
                🎨 <b>งานกราฟฟิก จ-ศ = งานประจำ</b> อยู่ในเงินเดือนอยู่แล้ว ไม่ได้คิดคลิปละ ฿{(m.rate || 0).toLocaleString()} ค่ะ
                <br />💰 <b>ยอดตรงนี้คือค่าขนมจากงานตัดต่อที่รับเพิ่มเท่านั้น</b> — คลิปละ ฿{(m.rate || 0).toLocaleString()} รวมงานกราฟิกในคลิปนั้นแล้ว
