...
export default function WorkshopDetail() {
  ...
  return (
    <div style={{ minHeight: "100vh" }}>
      ...
      {/* 📱 มือถือ: กล่องจองต้องอยู่ "ล่างสุด" (คิมสั่ง 21 ส.ค. 69)
          ของเดิมดันกล่องจองขึ้นบนสุด เปิดหน้ามาเจอฟอร์มกรอกทันที — "มันเปิดมาแล้วเป็นให้สมัครเลยอ่ะงง"
          คนยังไม่รู้เลยว่าคลาสสอนอะไร ยังไม่ทันเห็นรีวิว ก็ให้กรอกชื่อแล้ว
          ลำดับที่ถูก = อ่านรายละเอียด → ดูรีวิวคนที่เรียนจริง → ค่อยตัดสินใจจอง
          บนคอมไม่เกี่ยว ยังเป็นสองคอลัมน์ กล่องจองลอยอยู่ข้างขวาเหมือนเดิม */}
